        ...
        while (true) {
            ...
            if (input.equals("bye")) {
                ...
                if (parts.length < 2 || parts[0].trim().isEmpty() || parts[1].trim().isEmpty()) {
                    System.out.println(" Please provide a valid description and deadline, e.g., 'deadline return book /by Sunday'.");
                } else {
                ...
                if (parts.length < 2 || parts[0].trim().isEmpty()) {
                    System.out.println(" Please provide a valid description and event time, e.g., 'event project meeting /from Mon 2pm /to 4pm'.");
                } else {
                    String[] timeParts = parts[1].split(" /to ", 2);
                    if (timeParts.length < 2 || timeParts[0].trim().isEmpty() || timeParts[1].trim().isEmpty()) {
                        System.out.println(" Please provide both start and end times, e.g., 'event project meeting /from Mon 2pm /to 4pm'.");
                    } else {
                ...
                System.out.println(" Only 'list', 'mark <num>', 'unmark <num>', 'todo <desc>', 'deadline <desc> /by <time>', 'event <desc> /from <start> /to <end>', and 'bye' commands are supported.");
                System.out.println("____________________________________________________________");
            }
        }
